...
def generate_and_check(private_key, existing_addresses, vanity_pattern=None):
    ...
    if vanity_pattern and re.match(vanity_pattern, bitcoin_address):
...
def main():
    ...
    while True:
        ...
        generate_and_check(private_key, existing_addresses, vanity_pattern)
